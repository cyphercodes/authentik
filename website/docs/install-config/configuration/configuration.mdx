...
Global SMTP settings for authentik.

These settings are used for administrator notifications, release and configuration alerts, [notification rules](../../sys-mgmt/events/notifications.md), and any Email stage configured to use global settings.
...
- `AUTHENTIK_EMAIL__FROM`
    ...
    Sender address used by authentik. This should be a valid address for your domain.
